...
public class OpenApiConfiguration {
    ...
    public SwaggerCustomizer noApiFirstCustomizer() {
        return docket -> docket.select()
            .apis(Predicates.not(RequestHandlerSelectors.basePackage("de.uni_stuttgart.it_rex.quiz.web.api")));
    }
    ...
    public Docket apiFirstDocket(JHipsterProperties jHipsterProperties) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("de.uni_stuttgart.it_rex.quiz.web.api"))
